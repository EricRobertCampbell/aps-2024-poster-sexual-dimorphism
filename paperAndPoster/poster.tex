...
\block{Introduction}{
  \begin{itemize}
    ...
    \item Determining sex and size of an extinct organism is difficult, and existing methods suffer from low statistical power and confounding by e.g. juveniles
...
\text{logistic}(\text{age}, L, q, k) = \frac{L}{1 + e^{q+k \ast \text{age}}}
  ...
  \end{itemize}
\begin{tikzfigure}[Posterior growth curves and data]
  \centering
