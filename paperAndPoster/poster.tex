...
\block{Introduction}{
  \begin{itemize}
    ...
    \item Determining sex and size of an extinct organism is difficult, and existing methods to determine dimorphism suffer from low statistical power and confounding by e.g. presence of juveniles
...
\block{Verification}{
  ...
  \begin{minipage}[t]{0.45\colwidth}
    ...
    \end{align*}
  \end{minipage}
    $L$: asymptotic length; $A$: related to size at hatching; $K$: related to growth rate.
...
\text{logistic}(\text{age}, L, q, k) = \frac{L}{1 + e^{q+k \ast \text{age}}}
  \]
  $L$: asymptotic mass; $q$: related to initial mass; $k$: growth rate.
  \end{itemize}
